...
const Achievements = () => {
    ...
    const AchievementsList = [
        ...
        {AchievementsId:2,name:"Alpha",description:"Be the Top 1 player of the leaderboard",image_url:"images/610295.png",unlock:true},
        ...
        {AchievementsId:5,name:"Alpha",description:"Be the Top 1 player of the leaderboard",image_url:"images/610295.png",unlock:false},
        {AchievementsId:6,name:"Alpha",description:"Be the Top 1 player of the leaderboard",image_url:"images/610295.png",unlock:true},
        {AchievementsId:7,name:"Alpha",description:"Be the Top 1 player of the leaderboard",image_url:"images/610295.png",unlock:true},   
    ];
    return (
        <>
        <div className='body'>
